...
#line 198 "parser.tab.c" /* yacc.c:339  */
...
{
       0,   178,   178,   179,   180,   181,   184,   253,   257,   256,
     377,   376,   393,   396,   397,   400,   401,   404,   521,   533,
     539,   547,   548,   549,   551,   550,   565,   565,   637,   638,
     639,   640,   660,   666,   665,   684,   687,   699,   706,   707,
     711,   710,   735,   736,   761,   845,   928,  1011,  1094,  1177,
    1182,  1181,  1310,  1313,  1353,  1394,  1435,  1475,  1491,  1494,
    1495,  1496,  1497,  1498,  1556
};
#endif
...
static const char *const yytname[] =
{
  ...
  "body", "decls", "stmts", "decl", "kind", "stmt", "$@3", "$@4", "$@5",
  "write_expr_list", "wlist_unit", "wlist_rep", "var_list", "$@6",
  "var_list_rep", "bool_expr", "expr", "$@7", "expr1", "factor",
...
{
     -65,   118,   -65,   -18,   -65,   -65,   -65,   -65,   -65,    65,
     -65,   -13,     7,    15,   -65,   123,   -65,   -65,    22,     4,
      11,   -65,    28,    50,    69,    36,   -65,   -65,   -65,   -65,
     -65,    36,    57,   -65,    12,   -65,    82,    67,   -11,   -65,
     -65,    80,   -65,    99,   114,    81,    99,   -65,   -65,   106,
     -65,    84,    61,   -65,   -65,   -65,   -65,    99,    87,    99,
     105,   111,   117,    77,   119,   -65,   120,   -65,   -65,   121,
      34,   125,   -65,   -65,   101,   101,   101,   101,   126,    99,
     127,    73,    99,   -65,   -65,   122,   -65,   -65,   124,   -65,
     -65,    94,    94,   -65,   -65,   -65,   -65,    64,    99,    99,
      99,    99,    99,    99,   129,   -65,     2,   136,   -65,   -65,
...
{
       2,     0,     1,     0,    19,    20,     5,     3,     4,     0,
       7,     0,    40,     0,    18,     0,    42,    17,     0,     0,
      41,    10,     0,     0,     0,     0,     8,     6,    43,    13,
      11,     0,    15,     9,     0,    14,     0,     0,    63,    59,
      60,     0,    24,     0,     0,     0,     0,    15,    12,     0,
      16,     0,    52,    58,    61,    40,    23,     0,     0,     0,
       0,     0,     0,     0,     0,    37,     0,    38,    36,     0,
       0,    63,    57,    22,     0,     0,     0,     0,     0,     0,
       0,     0,     0,    31,    28,     0,    30,    29,    35,    62,
      21,    53,    54,    55,    56,    64,    51,     0,     0,     0,
       0,     0,     0,     0,     0,    27,     0,    32,    49,    44,
      45,    46,    47,    48,     0,    39,    33,    25,     0,    34
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int16 yypgoto[] =
{
     -65,   -65,   -65,   -65,   -65,   -65,   116,   -65,   102,   128,
      -4,   -64,   -65,   -65,   -65,   -65,    42,   -65,    88,   -65,
     -65,    68,   -43,   -65,    58,   103,   -65
};

  /* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
      -1,     1,     6,     7,    31,    25,    30,    32,    34,     8,
       9,    50,    60,    63,   118,    66,    67,    88,    13,    16,
      20,    80,    51,    58,    52,    53,    54
};
...
{
      61,    10,    68,    69,    57,    38,    14,    22,    39,    40,
      65,    19,   -50,    37,    78,    38,    81,    46,    39,    40,
      23,    41,    15,    42,    43,    44,    45,    46,    36,    47,
      48,    24,    49,   107,    17,    37,    96,    38,    21,    81,
      39,    40,    49,    41,    26,    42,    43,    44,    45,    46,
     117,    47,    90,    29,   119,   108,   109,   110,   111,   112,
     113,     4,     5,    68,    49,    37,    11,    38,    12,    27,
      39,    40,    28,    41,    98,    42,    43,    44,    45,    46,
      55,    47,    64,    11,    38,    55,    56,    39,    40,    65,
      74,    75,    76,    77,    49,    59,    46,    99,   100,   101,
     102,   103,    38,    73,    71,    39,    40,    39,    40,    71,
      79,    49,    39,    40,    46,    62,    46,   -26,     2,     3,
      82,    46,     4,     5,    18,    76,    77,     4,     5,    49,
      83,    49,    91,    92,    93,    94,    84,    89,    86,    87,
      57,   105,    95,    97,   106,   114,   116,    33,   115,    70,
     104,    85,    72,     0,     0,     0,     0,     0,     0,     0,
      35
};

static const yytype_int8 yycheck[] =
{
      43,    19,    45,    46,    15,     3,    19,     3,     6,     7,
       8,    15,    23,     1,    57,     3,    59,    15,     6,     7,
      16,     9,    15,    11,    12,    13,    14,    15,    32,    17,
      18,    20,    30,    97,    19,     1,    79,     3,    16,    82,
       6,     7,    30,     9,    16,    11,    12,    13,    14,    15,
     114,    17,    18,    17,   118,    98,    99,   100,   101,   102,
     103,     4,     5,   106,    30,     1,     1,     3,     3,    19,
       6,     7,     3,     9,     1,    11,    12,    13,    14,    15,
       3,    17,     1,     1,     3,     3,    19,     6,     7,     8,
      29,    30,    31,    32,    30,    15,    15,    24,    25,    26,
      27,    28,     3,    19,     3,     6,     7,     6,     7,     3,
      23,    30,     6,     7,    15,     1,    15,     3,     0,     1,
      15,    15,     4,     5,     1,    31,    32,     4,     5,    30,
      19,    30,    74,    75,    76,    77,    19,    16,    19,    19,
      15,    19,    16,    16,    20,    16,    10,    31,   106,    47,
      82,    63,    49,    -1,    -1,    -1,    -1,    -1,    -1,    -1,
      32
};
...
static const yytype_uint8 yystos[] =
{
      ...
      40,    38,    41,    40,    42,    43,    44,     1,     3,     6,
       7,     9,    11,    12,    13,    14,    15,    17,    18,    30,
      45,    56,    58,    59,    60,     3,    19,    15,    57,    15,
      46,    56,     1,    47,     1,     8,    49,    50,    56,    56,
      42,     3,    59,    19,    29,    30,    31,    32,    56,    23,
      55,    56,    15,    19,    19,    52,    19,    19,    51,    16,
      18,    58,    58,    58,    58,    16,    56,    16,     1,    24,
      25,    26,    27,    28,    55,    19,    20,    45,    56,    56,
      56,    56,    56,    56,    16,    50,    10,    45,    48,    45
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      39,    37,    40,    41,    41,    42,    42,    43,    43,    44,
      44,    45,    45,    45,    46,    45,    47,    45,    45,    45,
      45,    45,    45,    48,    45,    49,    50,    50,    51,    51,
      53,    52,    54,    54,    55,    55,    55,    55,    55,    55,
      57,    56,    56,    58,    58,    58,    58,    58,    58,    59,
      59,    59,    59,    59,    60
};
...
#line 257 "parser.y" /* yacc.c:1646  */
    {
						...
						while(temp != NULL) {	// search for function decl in global table
							...
							if((strcmp(temp->name, (yyvsp[-4].s)) == 0) && (temp->declared)) { // found declaration
...
#line 641 "parser.y" /* yacc.c:1646  */
    {
						if((yyvsp[-1].a)->nodetype == 'N') {
							if((yyvsp[-1].a)->datatype == TYPE_INT) {
								fprintf(fd, "COPY #%d %d\n", (int)(((struct numval *)(yyvsp[-1].a))->val), current_func->ret_mem_loc);
							}
							else {
								fprintf(fd, "COPYF #%lf %d\n", ((struct numval *)(yyvsp[-1].a))->val, current_func->ret_mem_loc);
							}
						}
						else {
							if((yyvsp[-1].a)->datatype == TYPE_INT) {
...
#line 688 "parser.y" /* yacc.c:1646  */
    {
					// TARGET CODE GENERATION
					if((yyvsp[0].a)->datatype == TYPE_INT) {
						fprintf(fd, "WRITE ");
						(yyvsp[0].a)->nodetype == 'N' ? fprintf(fd, "#%d\n", (int)((struct numval *)(yyvsp[0].a))->val) : fprintf(fd, "%d\n", (yyvsp[0].a)->mem_loc);
					}
					else {
						fprintf(fd, "WRITEF ");
						(yyvsp[0].a)->nodetype == 'N' ? fprintf(fd, "#%d\n", ((struct numval *)(yyvsp[0].a))->val) : fprintf(fd, "%d\n", (yyvsp[0].a)->mem_loc);
					}
				}
...
#line 762 "parser.y" /* yacc.c:1646  */
    {
					if((yyvsp[-2].a)->datatype != (yyvsp[0].a)->datatype) { // error: MIXED TYPE in logic op
						...
						if((yyvsp[-2].a)->nodetype == 'I') {
							...
							printf("ERROR: Comparing %s value with ", data_type[(yyvsp[-2].a)->datatype]);
						}
						...
						if((yyvsp[-2].a)->datatype == TYPE_INT) {
																
							if((yyvsp[-2].a)->nodetype == 'N')
								sprintf(operand1, "#%d", (int)((struct numval *)(yyvsp[-2].a))->val);
							else
								sprintf(operand1, "%d", (yyvsp[-2].a)->mem_loc);
							
							if((yyvsp[0].a)->nodetype == 'N')
								sprintf(operand2, "#%d", (int)((struct numval *)(yyvsp[0].a))->val);
							else
								sprintf(operand2, "%d", (yyvsp[0].a)->mem_loc);
							...
							if((yyvsp[-2].a)->nodetype == 'N')
								sprintf(operand1, "#%lf", ((struct numval *)(yyvsp[-2].a))->val);
							else
								sprintf(operand1, "%d", (yyvsp[-2].a)->mem_loc);
							
							if((yyvsp[0].a)->nodetype == 'N')
								sprintf(operand2, "#%lf", ((struct numval *)(yyvsp[0].a))->val);
							else
								sprintf(operand2, "%d", (yyvsp[0].a)->mem_loc);
...
#line 1224 "parser.y" /* yacc.c:1646  */
    {
					...
					if(ltable != NULL) {
						...
						while(temp != NULL) { /* local symbol table */
							...
							if(strcmp(temp->name, (yyvsp[-3].s)) == 0) { // variable found in local table
								...
								if((yyvsp[0].a)->datatype != temp->val_type) {
									...
									if(temp->val_type == TYPE_INT) {
										fprintf(fd, "COPY ");
										(yyvsp[0].a)->nodetype == 'N' ? fprintf(fd, "#%d ", (int)((struct numval *)(yyvsp[0].a))->val) : fprintf(fd, "%d ", (yyvsp[0].a)->mem_loc);
										fprintf(fd, "%d\n", temp->mem_loc);
									}
									else {
										fprintf(fd, "COPYF ");
										(yyvsp[0].a)->nodetype == 'N' ? fprintf(fd, "#%lf ", ((struct numval *)(yyvsp[0].a))->val) : fprintf(fd, "%d ", (yyvsp[0].a)->mem_loc);
										fprintf(fd, "%d\n", temp->mem_loc);
									}
    ...
    { 
					...
					if((yyvsp[-2].a)->datatype != (yyvsp[0].a)->datatype) { // error: mixed types in arithmetic op
						...
						if((yyval.a)->datatype == TYPE_INT) {
							fprintf(fd, "ADD ");
							(yyvsp[-2].a)->nodetype == 'N' ? fprintf(fd, "#%d ", (int)((struct numval *)(yyvsp[-2].a))->val) : fprintf(fd, "%d ", (yyvsp[-2].a)->mem_loc);
							(yyvsp[0].a)->nodetype == 'N' ? fprintf(fd, "#%d ", (int)((struct numval *)(yyvsp[0].a))->val) : fprintf(fd, "%d ", (yyvsp[0].a)->mem_loc);
						}
						else {
							fprintf(fd, "ADDF ");
							(yyvsp[-2].a)->nodetype == 'N' ? fprintf(fd, "#%lf ", ((struct numval *)(yyvsp[-2].a))->val) : fprintf(fd, "%d ", (yyvsp[-2].a)->mem_loc);
							(yyvsp[0].a)->nodetype == 'N' ? fprintf(fd, "#%lf ", ((struct numval *)(yyvsp[0].a))->val) : fprintf(fd, "%d ", (yyvsp[0].a)->mem_loc);
						}
						fprintf(fd, "%d\n", (yyval.a)->mem_loc);
					}
						...
						if(ltable != NULL) { /* check if a variable is used as a function */
							...
							while(temp != NULL) { 
								if(strcmp(temp->name, (yyvsp[-3].s)) == 0) {
									...
									// AST =============================================================
									(yyval.a) = newfcall(NULL, yylineno);
							...
							while(temp != NULL) {
								if(strcmp(temp->name, (yyvsp[-3].s)) == 0) {
									...
									if(temp->implemented) {
										...
										if((yyvsp[-1].a)->datatype == TYPE_INT) {
											if((yyvsp[-1].a)->nodetype == 'N') {
												fprintf(fd, "COPY #%d %d\n", (int)(((struct numval *)(yyvsp[-1].a))->val), temp->mem_loc);
											}
											else {
												fprintf(fd, "COPY %d %d\n", (yyvsp[-1].a)->mem_loc, temp->mem_loc);
											}
										}
										else {
											if((yyvsp[-1].a)->nodetype == 'N') {
												fprintf(fd, "COPYF #%lf %d\n", ((struct numval *)(yyvsp[-1].a))->val, temp->mem_loc);
											}
											else {
												fprintf(fd, "COPYF %d %d\n", (yyvsp[-1].a)->mem_loc, temp->mem_loc);
											}
										...
										// AST ==================================================================
										(yyval.a) = newfcall(temp, yylineno);
...
#line 1678 "parser.y" /* yacc.c:1906  */
